...
class FriendshipRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship_request" do
    assert_difference('FriendshipRequest.count') do
      post friendship_requests_url, params: { friendship_request: { friend_id: @friendship_request.friend_id, pending: @friendship_request.pending, user_id: @friendship_request.user_id } }
    end
  ...
  test "should update friendship_request" do
    patch friendship_request_url(@friendship_request), params: { friendship_request: { friend_id: @friendship_request.friend_id, pending: @friendship_request.pending, user_id: @friendship_request.user_id } }
